...
<template>
  ...
  <ul>
    ...
    <li>Added <router-link to="/help">Find MAX DPS</router-link> button to equipment edit window</li>
  ...
  <ul>
    ...
    <li>Extended Data-><router-link to="/data/sd_upgrade">SD Upgrade</router-link> to all Super Dungeon upgrades</li>
  </ul>
  <h2>0.1.16</h2>
  <ul>
