...
export class ChallengeHandicap_NariSuneLv650 extends CHALLENGE {
  kind: ChallengeKind = ChallengeKind.HCNariSune650;
  ...
  SetReward() {
    globalThis.data.stats.SetEffectBasicStats(
      ...
      new MultiplierInfo(
        ...
        MultiplierType.Mul,
        () => 0.9 * globalThis.data.challenge.permanentRewardMultiplier.Value(),
