...
export class AttackingOrder extends SKILL {
  ...
  constructor(data: DATA, heroKind: HeroKind, id) {
    ...
    this.passiveEffectLists.push(SkillPassiveEffect.SkillPassive(this, 250, SkillPassiveKind.ThisSkillPetDamageMultiplier, 32.0, MultiplierType.Add));
    ...
    this.passiveEffectLists.push(SkillPassiveEffect.SkillPassive(this, 425, SkillPassiveKind.ThisSkillPetDamageMultiplier, 192.0, MultiplierType.Add));
