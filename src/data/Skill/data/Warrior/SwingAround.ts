...
export class SwingAround extends SKILL {
  constructor(data: DATA, heroKind: HeroKind, id) {
    ...
    this.passiveEffectLists.push(SkillPassiveEffect.Register(this, 150, () => Localization.WarriorSkillsString(2, 150)));
    ...
    this.passiveEffectLists.push(SkillPassiveEffect.Register(this, 500, () => Localization.WarriorSkillsString(2, 150)));
    ...
    this.passiveEffectLists.push(SkillPassiveEffect.Register(this, 800, () => Localization.WarriorSkillsString(2, 150)));
