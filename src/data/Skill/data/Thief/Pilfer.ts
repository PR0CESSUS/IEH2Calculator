...
export class Pilfer extends SKILL {
  constructor(data: DATA, heroKind: HeroKind, id) {
    ...
    this.passiveEffectLists.push(SkillPassiveEffect.Stats(this, 275, Stats.EquipmentDropChance, MultiplierType.After, 0.0005));
    this.passiveEffectLists.push(SkillPassiveEffect.SkillBuff(this, 300, SkillBuffKind.EquipmentDropChanceAfter, 0.0005));
    ...
    this.passiveEffectLists.push(SkillPassiveEffect.Stats(this, 375, Stats.EquipmentDropChance, MultiplierType.After, 0.0002));
    this.passiveEffectLists.push(SkillPassiveEffect.SkillBuff(this, 400, SkillBuffKind.EquipmentDropChanceAfter, 0.0005));
    this.passiveEffectLists.push(SkillPassiveEffect.Stats(this, 425, Stats.ExpGain, MultiplierType.Mul, 1.5));
    this.passiveEffectLists.push(SkillPassiveEffect.Stats(this, 450, Stats.EquipmentDropChance, MultiplierType.After, 0.0002));
    this.passiveEffectLists.push(SkillPassiveEffect.SkillBuff(this, 475, SkillBuffKind.EquipmentDropChanceAfter, 0.0005));
    this.passiveEffectLists.push(SkillPassiveEffect.GlobalStats(this, 500, GlobalStats.GoldGain, MultiplierType.Mul, 1.0));
    this.passiveEffectLists.push(SkillPassiveEffect.Stats(this, 525, Stats.EquipmentDropChance, MultiplierType.After, 0.0002));
    this.passiveEffectLists.push(SkillPassiveEffect.SkillBuff(this, 550, SkillBuffKind.EquipmentDropChanceAfter, 0.0005));
    ...
    this.passiveEffectLists.push(SkillPassiveEffect.Stats(this, 625, Stats.EquipmentDropChance, MultiplierType.After, 0.0002));
    this.passiveEffectLists.push(SkillPassiveEffect.SkillBuff(this, 650, SkillBuffKind.EquipmentDropChanceAfter, 0.0005));
    ...
    this.passiveEffectLists.push(SkillPassiveEffect.Stats(this, 725, Stats.EquipmentDropChance, MultiplierType.After, 0.0002));
    this.passiveEffectLists.push(SkillPassiveEffect.SkillBuff(this, 750, SkillBuffKind.EquipmentDropChanceAfter, 0.0005));
    ...
    this.passiveEffectLists.push(SkillPassiveEffect.Stats(this, 825, Stats.EquipmentDropChance, MultiplierType.After, 0.0002));
    this.passiveEffectLists.push(SkillPassiveEffect.SkillBuff(this, 850, SkillBuffKind.EquipmentDropChanceAfter, 0.0005));
    ...
    this.passiveEffectLists.push(SkillPassiveEffect.Stats(this, 925, Stats.EquipmentDropChance, MultiplierType.After, 0.0002));
    this.passiveEffectLists.push(SkillPassiveEffect.SkillBuff(this, 950, SkillBuffKind.EquipmentDropChanceAfter, 0.0005));
  ...
  PilferChance() {
    let num = 0.05;
    if (this.level.value >= 60) num += 0.05;
    if (this.level.value >= 100) num += 0.05;
    if (this.level.value >= 150) num += 0.1;
    if (this.level.value >= 250) num += 0.25;
    return num;
  }
}
