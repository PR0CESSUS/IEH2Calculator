...
export class SDP_TimeLimit extends SuperDungeonPowerup {
  get kind() {
    return SuperDungeonPowerupKind.TimeLimit;
  }
  ...
  SetGlobalEffect() {
    this.sdgCtrl.additionalTimeLimit.RegisterMultiplier(new MultiplierInfo(MultiplierKind.DungeonItemPermanent, MultiplierType.Add, () => this.PermanentEffectValue));
  }
