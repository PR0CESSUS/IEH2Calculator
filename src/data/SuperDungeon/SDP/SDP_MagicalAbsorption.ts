...
export class SDP_MagicalAbsorption extends SuperDungeonPowerup {
  ...
  SetEffect() {
    globalThis.data.stats.ElementAbsorption(this.heroKind, Element.Fire).RegisterMultiplier(
      new MultiplierInfo(
    ...
    globalThis.data.stats.ElementAbsorption(this.heroKind, Element.Ice).RegisterMultiplier(
      new MultiplierInfo(
        MultiplierKind.DungeonItem,
        MultiplierType.After,
        () => this.EffectValue() * this.level,
    ...
    globalThis.data.stats.ElementAbsorption(this.heroKind, Element.Thunder).RegisterMultiplier(
      new MultiplierInfo(
        MultiplierKind.DungeonItem,
        MultiplierType.After,
        () => this.EffectValue() * this.level,
    ...
    globalThis.data.stats.ElementAbsorption(this.heroKind, Element.Light).RegisterMultiplier(
      new MultiplierInfo(
        MultiplierKind.DungeonItem,
        MultiplierType.After,
        () => this.EffectValue() * this.level,
    ...
    globalThis.data.stats.ElementAbsorption(this.heroKind, Element.Dark).RegisterMultiplier(
      new MultiplierInfo(
        MultiplierKind.DungeonItem,
        MultiplierType.After,
        () => this.EffectValue() * this.level,
