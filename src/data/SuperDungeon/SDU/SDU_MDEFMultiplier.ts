...
export class SDU_MDEFMultiplier extends SuperDungeonUpgrade {
  ...
  SetEffect() {
    return this.sdgCtrl.data.stats.SetEffectBasicStats(BasicStatsKind.MDEF, new MultiplierInfo(MultiplierKind.SDUpgrade, MultiplierType.Mul, () => this.EffectValue()));
  }
