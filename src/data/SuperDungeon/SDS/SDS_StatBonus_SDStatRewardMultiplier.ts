...
export class SDS_StatBonus_SDStatRewardMultiplier extends SuperDungeonShop_StatBonus {
  ...
  SetEffect() {return globalThis.data.challenge.sdStatRewardMultiplier.RegisterMultiplier(new MultiplierInfo(MultiplierKind.SDShop, MultiplierType.Mul, (() => this.effectValue)));}
}
