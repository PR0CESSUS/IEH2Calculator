...
export class SDS_StatBonus_TamingPointGain extends SuperDungeonShop_StatBonus {
  ...
  SetEffect() {return globalThis.data.stats.SetEffectStats(Stats.TamingPointGain, new MultiplierInfo(MultiplierKind.SDShop, MultiplierType.Mul, (() => this.effectValue)));}
}
