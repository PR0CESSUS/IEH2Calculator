...
export class SDS_StatBonus_SlimeCoinCap extends SuperDungeonShop_StatBonus {
  ...
  SetEffect() {return globalThis.data.resource.slimeCoinCap.RegisterMultiplier(new MultiplierInfo(MultiplierKind.SDShop, MultiplierType.Mul, (() => this.effectValue)));}
}
