...
import { PetRankMilestone } from "./PetRankMilestone";
export class DataMonster {
  ...
  globalInformations: MonsterGlobalInformation[][];
  ...
  constructor() {
    this.globalInformations = Array(Enums.MonsterSpecies);
    for (let species = 0; species < 10; species++) {
      ...
      for (let color = 0; color < this.globalInformations[species].length; color++) {
        this.globalInformations[species][color] = new MonsterGlobalInformation(species, color);
    ...
    for (let kind = 0; kind < this.globalInformations[11].length; kind++) {
      this.globalInformations[11][kind] = new MonsterGlobalInformation(MonsterSpecies.ChallengeBoss, kind);
  ...
  SetPetRankMilestone() {
    globalThis.data.stats.SetEffectStats(Stats.TamingPointGain, new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 0.1, this.isUnlocked(10)));
    ...
    globalThis.data.stats.SetEffectStats(Stats.TamingPointGain, new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 0.15, this.isUnlocked(40)));
    ...
    globalThis.data.stats.SetEffectStats(Stats.TamingPointGain, new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 0.25, this.isUnlocked(80)));
    ...
    globalThis.data.stats.SetEffectStats(Stats.TamingPointGain, new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 0.5, this.isUnlocked(140)));
    ...
    globalThis.data.stats.SetEffectPetEXPGain(new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 0.25, this.isUnlocked(240)));
    globalThis.data.stats.SetEffectStats(Stats.TamingPointGain, new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 0.75, this.isUnlocked(260)));
    ...
    globalThis.data.stats.SetEffectLoyalityPointGain(new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 0.1, this.isUnlocked(440)));
    globalThis.data.stats.SetEffectPetEXPGain(new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 0.5, this.isUnlocked(480)));
    ...
    globalThis.data.stats.SetEffectStats(Stats.TamingPointGain, new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 1.0, this.isUnlocked(520)));
    globalThis.data.stats.SetEffectLoyalityPointGain(new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 0.15, this.isUnlocked(540)));
    ...
    globalThis.data.stats.SetEffectPetEXPGain(new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 0.75, this.isUnlocked(700)));
    ...
    globalThis.data.stats.SetEffectLoyalityPointGain(new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 0.2, this.isUnlocked(740)));
    ...
    globalThis.data.stats.SetEffectPetEXPGain(new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 1.0, this.isUnlocked(950)));
    ...
    globalThis.data.stats.SetEffectStats(Stats.TamingPointGain, new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 1.25, this.isUnlocked(1025)));
    globalThis.data.stats.SetEffectLoyalityPointGain(new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 0.2, this.isUnlocked(1050)));
    ...
    globalThis.data.stats.SetEffectPetEXPGain(new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 1.25, this.isUnlocked(1250)));
    globalThis.data.stats.SetEffectLoyalityPointGain(new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 0.25, this.isUnlocked(1300)));
    ...
    globalThis.data.stats.SetEffectStats(Stats.TamingPointGain, new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 1.5, this.isUnlocked(1550)));
    ...
    globalThis.data.stats.SetEffectPetEXPGain(new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 1.5, this.isUnlocked(1750)));
    globalThis.data.stats.SetEffectLoyalityPointGain(new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 0.3, this.isUnlocked(1800)));
    ...
    globalThis.data.stats.SetEffectStats(Stats.TamingPointGain, new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 1.75, this.isUnlocked(2050)));
    ...
    globalThis.data.stats.SetEffectPetEXPGain(new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 1.75, this.isUnlocked(2250)));
    globalThis.data.stats.SetEffectLoyalityPointGain(new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 0.35, this.isUnlocked(2300)));
    ...
    globalThis.data.stats.SetEffectStats(Stats.TamingPointGain, new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 2.0, this.isUnlocked(2550)));
    ...
    globalThis.data.stats.SetEffectPetEXPGain(new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 2.0, this.isUnlocked(2750)));
    globalThis.data.stats.SetEffectLoyalityPointGain(new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 0.4, this.isUnlocked(2800)));
    ...
    globalThis.data.stats.SetEffectStats(Stats.TamingPointGain, new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 2.25, this.isUnlocked(3050)));
    ...
    globalThis.data.stats.SetEffectPetEXPGain(new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 2.25, this.isUnlocked(3250)));
    globalThis.data.stats.SetEffectLoyalityPointGain(new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 0.45, this.isUnlocked(3300)));
    ...
    globalThis.data.stats.SetEffectStats(Stats.TamingPointGain, new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 2.5, this.isUnlocked(3550)));
    ...
    globalThis.data.stats.SetEffectPetEXPGain(new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 2.5, this.isUnlocked(3750)));
    globalThis.data.stats.SetEffectLoyalityPointGain(new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 0.5, this.isUnlocked(3800)));
    ...
    globalThis.data.stats.SetEffectStats(Stats.TamingPointGain, new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 2.75, this.isUnlocked(4050)));
    ...
    globalThis.data.stats.SetEffectPetEXPGain(new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 2.75, this.isUnlocked(4250)));
    globalThis.data.stats.SetEffectLoyalityPointGain(new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 0.65, this.isUnlocked(4300)));
    ...
    globalThis.data.stats.SetEffectStats(Stats.TamingPointGain, new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 3.0, this.isUnlocked(4550)));
    ...
    globalThis.data.stats.SetEffectPetEXPGain(new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 3.0, this.isUnlocked(4750)));
    globalThis.data.stats.SetEffectLoyalityPointGain(new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 0.9, this.isUnlocked(4800)));
    ...
    globalThis.data.stats.SetEffectStats(Stats.TamingPointGain, new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 5.0, this.isUnlocked(5150)));
    ...
    globalThis.data.stats.SetEffectPetEXPGain(new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 3.5, this.isUnlocked(5250)));
    globalThis.data.stats.SetEffectLoyalityPointGain(new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 1.5, this.isUnlocked(5300)));
    ...
    globalThis.data.stats.SetEffectStats(Stats.TamingPointGain, new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 10.0, this.isUnlocked(5550)));
    ...
    globalThis.data.stats.SetEffectPetEXPGain(new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 4.0, this.isUnlocked(5750)));
    globalThis.data.stats.SetEffectLoyalityPointGain(new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 5.0, this.isUnlocked(5800)));
    ...
    globalThis.data.stats.SetEffectStats(Stats.TamingPointGain, new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 20.0, this.isUnlocked(6050)));
    ...
    globalThis.data.stats.SetEffectPetEXPGain(new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 4.5, this.isUnlocked(6250)));
    globalThis.data.stats.SetEffectLoyalityPointGain(new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 15.0, this.isUnlocked(6300)));
    ...
    globalThis.data.stats.SetEffectStats(Stats.TamingPointGain, new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 30.0, this.isUnlocked(6550)));
    ...
    globalThis.data.stats.SetEffectPetEXPGain(new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 5.5, this.isUnlocked(6750)));
    globalThis.data.stats.SetEffectLoyalityPointGain(new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 30.0, this.isUnlocked(6800)));
    ...
    globalThis.data.stats.SetEffectStats(Stats.TamingPointGain, new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 50.0, this.isUnlocked(7050)));
    ...
    globalThis.data.stats.SetEffectPetEXPGain(new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 7.0, this.isUnlocked(7250)));
    globalThis.data.stats.SetEffectLoyalityPointGain(new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 50.0, this.isUnlocked(7300)));
    ...
    globalThis.data.stats.SetEffectStats(Stats.TamingPointGain, new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 100.0, this.isUnlocked(7550)));
    ...
    globalThis.data.stats.SetEffectPetEXPGain(new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 9.0, this.isUnlocked(7750)));
    globalThis.data.stats.SetEffectLoyalityPointGain(new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 100.0, this.isUnlocked(7800)));
    ...
    globalThis.data.stats.SetEffectStats(Stats.TamingPointGain, new MultiplierInfo(MultiplierKind.PetRankMilestone, MultiplierType.Mul, () => 300.0, this.isUnlocked(8050)));
