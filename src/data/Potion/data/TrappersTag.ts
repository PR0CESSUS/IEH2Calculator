...
export class TrappersTag extends Talisman {
  ...
  SetPassiveEffect() {
    this.data.stats.SetEffectStats(Stats.TamingPointGain, new MultiplierInfo(MultiplierKind.TalismanPassive, MultiplierType.Mul, () => this.passiveEffectValue));
  }

  SetEffect(heroKind: HeroKind, equipNum: Function) {
    return this.data.monster.captureTripleChance[heroKind].RegisterMultiplier(
      new MultiplierInfo(
