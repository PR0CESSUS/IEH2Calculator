...
export class TamersBadge extends Talisman {
  ...
  SetPassiveEffect() {
    this.data.skill.skillRankCostFactors[5].RegisterMultiplier(new MultiplierInfo(MultiplierKind.TalismanPassive, MultiplierType.Mul, () => -this.passiveEffectValue));
  }
