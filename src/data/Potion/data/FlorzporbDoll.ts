...
export class FlorzporbDoll extends Talisman {
  get talismanKind() {
    return PotionKind.FlorzporbDoll;
  }
  ...
  SetPassiveEffect() {
    this.data.stats.GoldGain().RegisterMultiplier(new MultiplierInfo(MultiplierKind.TalismanPassive, MultiplierType.Mul, () => this.passiveEffectValue));
  }

  SetEffect(heroKind: HeroKind, equipNum: Function) {
    return this.data.skill.baseAttackSlimeBall[heroKind].RegisterMultiplier(
      new MultiplierInfo(
