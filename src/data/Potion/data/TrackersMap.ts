...
export class TrackersMap extends Talisman {
  ...
  SetPassiveEffect() {
    this.data.area.epicSwarmChanceInsteadOfLarge.RegisterMultiplier(new MultiplierInfo(MultiplierKind.Talisman, MultiplierType.Add, () => this.passiveEffectValue));
  }

  SetEffect(heroKind: HeroKind, equipNum: Function) {
    return this.data.area.clearCountBonusClass[heroKind].RegisterMultiplier(
      new MultiplierInfo(
