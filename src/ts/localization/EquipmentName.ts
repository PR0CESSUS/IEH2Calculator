...
export function EquipmentName(kind: EquipmentKind) {
  switch (kind) {
    ...
    case EquipmentKind.FlametigerCostume:
      return "Flametiger Costume";
    case EquipmentKind.RingOfFlametigersWrath:
      return "Ring of the Flametiger's Wrath";
    case EquipmentKind.EndlessBowlOfSpicyFlametigerRamen:
      return "Endless Bowl of Spicy Flametiger Ramen";
    case EquipmentKind.ScreenOfTheSneakyFlametiger:
      return "Screen of the Sneaky Flametiger";
