...
export class ProtectWall extends SKILL {
  ...
  get buff() {return Buff.DefMDefUp;}
  ...
  SetBuff(heroKind: HeroKind) {
    ...
    let multiplierInfo2 = new MultiplierInfo(MultiplierKind.Buff, MultiplierType.Add, () => this.InvalidValue, (() => this.IsActiveBuff(heroKind)));
