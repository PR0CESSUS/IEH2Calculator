...
export class Haste extends SKILL {
  ...
  SetBuff(heroKind: HeroKind) {
    ...
    let multiplierInfo2 = new MultiplierInfo(MultiplierKind.Buff, MultiplierType.Mul, () => this.MoveSpeedValue, (() => this.IsActiveBuff(heroKind)));
