...
export class DataExpedition {
  ...
  constructor() {
    this.speedMultiplier = new Multiplier(new MultiplierInfo(MultiplierKind.Base, MultiplierType.Add, () => 1.0), null, null);
  ...
  SetMilestone() {
    ...
    if (totalLevel >= 425) globalThis.data.monster.petStatsMultiplier.RegisterMultiplier(new MultiplierInfo(MultiplierKind.ExpeditionMilestone, MultiplierType.Add, () => 0.25));
    ...
    if (totalLevel >= 525) globalThis.data.monster.petStatsMultiplier.RegisterMultiplier(new MultiplierInfo(MultiplierKind.ExpeditionMilestone, MultiplierType.Add, () => 0.5));
    ...
    if (totalLevel >= 625) globalThis.data.monster.petStatsMultiplier.RegisterMultiplier(new MultiplierInfo(MultiplierKind.ExpeditionMilestone, MultiplierType.Add, () => 0.75));
    ...
    if (totalLevel >= 725) globalThis.data.monster.petStatsMultiplier.RegisterMultiplier(new MultiplierInfo(MultiplierKind.ExpeditionMilestone, MultiplierType.Add, () => 1.0));
    if (totalLevel >= 750) globalThis.data.monster.petRankCap.RegisterMultiplier(new MultiplierInfo(MultiplierKind.ExpeditionMilestone, MultiplierType.Add, () => 50.0));
    ...
    if (totalLevel >= 800) globalThis.data.monster.loyaltyCap.RegisterMultiplier(new MultiplierInfo(MultiplierKind.ExpeditionMilestone, MultiplierType.Add, () => 100.0));
    if (totalLevel >= 825) globalThis.data.monster.petStatsMultiplier.RegisterMultiplier(new MultiplierInfo(MultiplierKind.ExpeditionMilestone, MultiplierType.Add, () => 2.0));
    ...
    if (totalLevel >= 875) this.fieldTrainingPassiveEffectMultiplier.RegisterMultiplier(new MultiplierInfo(MultiplierKind.ExpeditionMilestone, MultiplierType.Add, () => 9000000.0));
    ...
    if (totalLevel >= 925) globalThis.data.monster.petStatsMultiplier.RegisterMultiplier(new MultiplierInfo(MultiplierKind.ExpeditionMilestone, MultiplierType.Add, () => 3.5));
    ...
    if (totalLevel >= 975) this.fieldTrainingPassiveEffectMultiplier.RegisterMultiplier(new MultiplierInfo(MultiplierKind.ExpeditionMilestone, MultiplierType.Add, () => 90000000.0));
    if (totalLevel >= 1000) globalThis.data.resource.goldCap.RegisterMultiplier(new MultiplierInfo(MultiplierKind.ExpeditionMilestone, MultiplierType.Mul, () => 9.0));
    ...
    if (totalLevel >= 1100) globalThis.data.monster.petStatsMultiplier.RegisterMultiplier(new MultiplierInfo(MultiplierKind.ExpeditionMilestone, MultiplierType.Add, () => 5.0));
    ...
    if (totalLevel >= 1200) this.fieldTrainingPassiveEffectMultiplier.RegisterMultiplier(new MultiplierInfo(MultiplierKind.ExpeditionMilestone, MultiplierType.Add, () => 900000000.0));
    ...
    if (totalLevel >= 1300) globalThis.data.monster.petStatsMultiplier.RegisterMultiplier(new MultiplierInfo(MultiplierKind.ExpeditionMilestone, MultiplierType.Add, () => 7.5));
    ...
    if (totalLevel >= 1550) this.fieldTrainingPassiveEffectMultiplier.RegisterMultiplier(new MultiplierInfo(MultiplierKind.ExpeditionMilestone, MultiplierType.Add, () => 9000000000.0));
    if (totalLevel >= 1600) globalThis.data.monster.petStatsMultiplier.RegisterMultiplier(new MultiplierInfo(MultiplierKind.ExpeditionMilestone, MultiplierType.Add, () => 12.0));
    ...
    if (totalLevel >= 1850) this.fieldTrainingPassiveEffectMultiplier.RegisterMultiplier(new MultiplierInfo(MultiplierKind.ExpeditionMilestone, MultiplierType.Add, () => 90000000000.0));
    if (totalLevel >= 1900) globalThis.data.monster.petStatsMultiplier.RegisterMultiplier(new MultiplierInfo(MultiplierKind.ExpeditionMilestone, MultiplierType.Add, () => 20.0));
    ...
    if (totalLevel >= 2000) globalThis.data.resource.goldCap.RegisterMultiplier(new MultiplierInfo(MultiplierKind.ExpeditionMilestone, MultiplierType.Mul, () => 90.0));
    ...
    if (totalLevel >= 2400) this.fieldTrainingPassiveEffectMultiplier.RegisterMultiplier(new MultiplierInfo(MultiplierKind.ExpeditionMilestone, MultiplierType.Add, () => 900000000000.0));
    ...
    if (totalLevel >= 2600) globalThis.data.monster.petStatsMultiplier.RegisterMultiplier(new MultiplierInfo(MultiplierKind.ExpeditionMilestone, MultiplierType.Add, () => 40.0));
    if (totalLevel >= 2700) globalThis.data.monster.petRankCap.RegisterMultiplier(new MultiplierInfo(MultiplierKind.ExpeditionMilestone, MultiplierType.Add, () => 50.0));
    ...
    if (totalLevel >= 3000) globalThis.data.resource.goldCap.RegisterMultiplier(new MultiplierInfo(MultiplierKind.ExpeditionMilestone, MultiplierType.Mul, () => 900.0));
    if (totalLevel >= 3100) globalThis.data.monster.loyaltyCap.RegisterMultiplier(new MultiplierInfo(MultiplierKind.ExpeditionMilestone, MultiplierType.Add, () => 100.0));
    ...
    if (totalLevel >= 3400) this.fieldTrainingPassiveEffectMultiplier.RegisterMultiplier(new MultiplierInfo(MultiplierKind.ExpeditionMilestone, MultiplierType.Add, () => 9000000000000.0));
  }
}
