...
export class ShockingSlayersOil extends PotionGlobalInformation {
  ...
  SetEffect(heroKind: HeroKind, equipNum: Function) {return globalThis.data.stats.ElementSlayerDamage(heroKind, Element.Thunder).RegisterMultiplier(new MultiplierInfo(MultiplierKind.Potion, MultiplierType.Add, (() => this.effectValue), (() => this.IsActiveEffect(heroKind, equipNum))));}
