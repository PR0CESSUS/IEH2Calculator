...
export class LadyEmeldaDoll extends Talisman {
  get talismanKind() {return PotionKind.LadyEmeldaDoll;}

  get talismanRarity() {return TalismanRarity.Rare;}

  EffectValue(level) {return 0.025 * level;}
  ...
  SetEffect(heroKind: HeroKind, equipNum: Function) {return globalThis.data.skill.ladyEmeldaEffectMultiplier[heroKind].RegisterMultiplier(new MultiplierInfo(MultiplierKind.Talisman, MultiplierType.Add, (() => this.effectValue * equipNum()), (() => this.IsActiveEffect(heroKind, equipNum))));}
}
