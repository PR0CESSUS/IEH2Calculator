...
export class WhirlingAuraDraught extends PotionGlobalInformation {
  ...
  SetEffect(heroKind: HeroKind, equipNum: Function) {return globalThis.data.stats.DebuffChance(heroKind, Debuff.Electric).RegisterMultiplier(new MultiplierInfo(MultiplierKind.Potion, MultiplierType.Add, (() => this.effectValue), (() => this.IsActiveEffect(heroKind, equipNum))));}
