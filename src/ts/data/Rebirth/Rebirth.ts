...
export class Rebirth {
  ...
  Awake() {
    ...
    //     this.rebirthUpgrades = new RebirthUpgrade[5];
    ...
    //     this.rebirthPointKinds.Add(RebirthPointKind.Quest);
    //     this.rebirthPointKinds.Add(RebirthPointKind.Move);
    //     this.rebirthUpgrades = new RebirthUpgrade[8];
    ...
    //         this.rebirthUpgrades[7] = new RebirthUpgrade(this, RebirthUpgradeKind.T1eafGainBoost);
    //         return;
    //       case HeroKind.Thief:
    ...
    //         this.rebirthUpgrades[7] = new RebirthUpgrade(this, RebirthUpgradeKind.T1eafGoldCapBoost);
    //         return;
    //       default:
    //         return;
    //     }
    ...
    //     this.rebirthPointKinds.Add(RebirthPointKind.Quest);
    //     this.rebirthPointKinds.Add(RebirthPointKind.Move);
    //     this.rebirthUpgrades = new RebirthUpgrade[10];
    ...
    //         this.rebirthUpgrades[9] = new RebirthUpgrade(this, RebirthUpgradeKind.T2eafGainBoost);
    //         return;
    //       case HeroKind.Thief:
    ...
    //         this.rebirthUpgrades[9] = new RebirthUpgrade(this, RebirthUpgradeKind.T2eafGoldCapBoost);
    //         return;
    //       default:
    //         return;
    //     }
