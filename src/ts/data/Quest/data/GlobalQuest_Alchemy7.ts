...
export class GlobalQuest_Alchemy7 extends QUEST {
  constructor(questCtrl: QuestController, heroKind: HeroKind) {
    super(questCtrl, heroKind);

    this.kind = QuestKind.Global;
    this.globalQuestType = GlobalQuestType.Alchemy;
    this.kindGlobal = QuestKindGlobal.Alchemy7;
  ...
  StartQuest() {
    ...
    globalThis.data.alchemy.catalyst.catalystLevelCap.RegisterMultiplier(new MultiplierInfo(MultiplierKind.Quest, MultiplierType.Add, (() => 25.0), (() => this.isCleared)));
  }
}
