...
export class ChallengeHandicap_OctobaddieLv400 extends CHALLENGE {
  kind: ChallengeKind = ChallengeKind.HCOctobaddie400;
  ...
  SetReward() {
    globalThis.data.stats.SetEffectStats(
      ...
      new MultiplierInfo(
        ...
        MultiplierType.Mul,
        () => 0.1 * globalThis.data.challenge.permanentRewardMultiplier.Value(),
    ...
    globalThis.data.stats.ResourceGain(ResourceKind.Stone).RegisterMultiplier(
      new MultiplierInfo(
        MultiplierKind.Challenge,
        MultiplierType.Mul,
        () => 1.0 * globalThis.data.challenge.permanentRewardMultiplier.Value(),
