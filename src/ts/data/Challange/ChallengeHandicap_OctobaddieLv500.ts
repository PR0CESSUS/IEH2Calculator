...
export class ChallengeHandicap_OctobaddieLv500 extends CHALLENGE {
  kind: ChallengeKind = ChallengeKind.HCOctobaddie500;
  ...
  SetReward() {
    globalThis.data.stats.SetEffectStats(
      ...
      new MultiplierInfo(
        ...
        MultiplierType.Mul,
        () => 0.2 * globalThis.data.challenge.permanentRewardMultiplier.Value(),
    ...
    globalThis.data.stats.ResourceGain(ResourceKind.Stone).RegisterMultiplier(
      new MultiplierInfo(
        MultiplierKind.Challenge,
        MultiplierType.Mul,
        () => 5.0 * globalThis.data.challenge.permanentRewardMultiplier.Value(),
