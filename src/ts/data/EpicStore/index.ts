  ...
  constructor() {
    ...
    for (let heroKind = 0; heroKind < Enums.HeroKind; heroKind++) {
      globalThis.data.inventory.equipWeaponUnlockedNum[heroKind].RegisterMultiplier(
        new MultiplierInfo(
          MultiplierKind.Rebirth,
          MultiplierType.Add,
          () => globalThis.data.source.epicStorePurchasedNum[EpicStoreKind.EquipmentWeaponSlot1]
        )
      );
      globalThis.data.inventory.equipArmorUnlockedNum[heroKind].RegisterMultiplier(
        new MultiplierInfo(
          MultiplierKind.Rebirth,
          MultiplierType.Add,
          () => globalThis.data.source.epicStorePurchasedNum[EpicStoreKind.EquipmentArmorSlot1]
        )
      );
      globalThis.data.inventory.equipJewelryUnlockedNum[heroKind].RegisterMultiplier(
        new MultiplierInfo(
          MultiplierKind.Rebirth,
          MultiplierType.Add,
          () => globalThis.data.source.epicStorePurchasedNum[EpicStoreKind.EquipmentJewelrySlot1]
        )
      );
    }
